...
function Sandbox(options) {
  ...
  self.options = {
    timeout: 1500,
    node: 'C:/Users/dminkov/AppData/Roaming/nvm/v6.2.2/node.exe',
...
Sandbox.prototype.run = function(pathToCode, hollaback) {
  var self = this;
  var timer;
  var stdout = '';
  
  self.child = spawn(this.options.node, [this.options.shovel, pathToCode], { stdio: ['pipe', 'pipe', 'pipe', 'ipc'] });
  ...
  // Go
  // self.child.stdin.write(JSON.stringify(code));
